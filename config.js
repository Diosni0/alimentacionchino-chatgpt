...
export const OPENAI_CONFIG = {
    ...
    MAX_TOKENS: parseInteger(process.env.MAX_TOKENS, 80),
    ...
    REASONING_EFFORT: process.env.REASONING_EFFORT || 'none'
};
...
export const TWITCH_CONFIG = {
    ...
    CHANNELS: parseStringList(process.env.CHANNELS, []),
...
export const validateConfig = () => {
    ...
    if (!TWITCH_CONFIG.USERNAME) {
        errors.push('TWITCH_USER is required');
    }
    ...
    if (TWITCH_CONFIG.CHANNELS.length === 0) {
        errors.push('CHANNELS is required (comma-separated list)');
    }
    ...
    console.log('📋 Configuration loaded:', {
        ...
        reasoningEffort: OPENAI_CONFIG.REASONING_EFFORT,
